...
echo "============================================================="
echo "ICU Database Table Creation Script"
echo "-------------------------------------------------------------"
printf "This will CREATE all ICU database tables and sequences.\n"
printf "Are you sure you want to continue? (y/N): "
read CONFIRM

if [ "$CONFIRM" = "y" ]; then
    echo "Proceeding with table and sequence creation..."
...
EOF
    ...
    echo "-------------------------------------------------------------"
    echo "All ICU database tables and sequences created successfully."
else
    echo "Operation cancelled. No tables were created."
fi
